...
public class PatientRequestDTO {
    ...
    public @NotBlank(message = "Date of birth is required") String getRegisteredDate() {
        return registeredDate;
    }

    public void setRegisteredDate(@NotBlank(message = "Date of birth is required") String registeredDate) {
